...
<body style="background:url(./images/background/background.png);background-repeat:inherit;"> 
			<?php 
			...
			<div class="header-section">
				<div class="container">
					<div class="head-top">
						...
						<div class="language">
									<a href="female.php?lang=eng">English</a>
									<a href="female.php?lang=zho">中文</a>
						</div>
